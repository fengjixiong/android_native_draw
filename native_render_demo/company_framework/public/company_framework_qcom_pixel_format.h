#ifndef COMPANY__COMMON_PIXELFORMAT_H__
#define COMPANY__COMMON_PIXELFORMAT_H__

#include <cstdint>

typedef enum company_vendor_qti_hardware_display_common_PixelFormat : uint32_t {
