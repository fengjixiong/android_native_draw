...
#ifndef COMPANY__COMMON_BUFFERUSAGE_H__
#define COMPANY__COMMON_BUFFERUSAGE_H__

#include <cstdint>
typedef enum company_vendor_qti_hardware_display_common_BufferUsage : uint64_t {
  /** Bit 0-3 is an enum */
  CPU_READ_MASK = 0xf,
